    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          ...
          <p>BookMyDoc is committed to excellence in healthcare technology. We continuously strive to enhance our platform, integrating the latest advancements including AI-powered symptom checking and pharmacy integration to improve user experience and deliver superior service. Whether you're booking your first appointment or managing ongoing care, BookMyDoc is here to support you every step of the way.</p>
          <b className='text-gray-800 dark:text-gray-200'>Our Vision</b>
          <p>Our vision at BookMyDoc is to create a seamless healthcare experience for every user. We aim to bridge the gap between patients and healthcare providers, making it easier for you to access the care you need, when you need it, with the power of AI and modern technology.</p>
        </div>
      </div>
